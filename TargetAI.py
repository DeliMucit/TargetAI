...
from PyQt5.QtGui import QPixmap, QImage, QFont,QPainter,QPen,QKeySequence,QIcon
...
class Form(QWidget):
    ...
    def __init__(self):
        ...
        self.dil_tr=["Başla (CTRL+A)","Bekle (CTRL+W)","Sil (CTRL+D)","Kaydet (CTRL+S)","Video Seç","HSV Renk Fitresi","Renkli/Siyah Beyaz","Ekle","Etiket","Etiket Listesi","Yeniden Tara","TF Etiketi Kullan","TF ve Manuel","Sadece Manuel","TR"]
        self.dil_en=["Start (CTRL+A)","Wait (CTRL+W)","Delete (CTRL+D)","Save (CTRL+S)","Select Video","HSV Color Filter","Color/Black and White","Add","Label","Label List","Rescan","Use TF Label","TF and Manual","Only Manual","EN"]
        self.dil_ru=["Начать (CTRL+A)","Подождите (CTRL+W)","Удалить (CTRL+D)","Сохранить (CTRL+S)","Выбрать Видео","HSV Цветовой Фильтр","Цветной/Черно-белый","Добавить","Метка","Список Меток","Пересканировать","Использовать Метку TF","TF и Ручной Режим","Только Ручной Режим","RU"]
        ...
        self.pause_button.setText("Bekle (CTRL+W)")
        ...
        self.openCV_label.setGeometry(10, 320,200,20)
        ...
        self.hsv_color_checkbox = QCheckBox(self)
        self.hsv_color_checkbox.setText('Renkli/Siyah Beyaz')
        self.hsv_color_checkbox.setGeometry(15, 590,200, 30)
        self.hsv_color_checkbox.setChecked(False)  # Başlangıçta seçili olmasın
        self.hsv_color_checkbox.setEnabled(False)

        self.ticket_textbox = QLineEdit(self)
        self.ticket_textbox.setGeometry(65, 625,125,25)

        self.ticket_button = QPushButton(self)
        self.ticket_button.setText("Ekle")
        self.ticket_button.setGeometry(5, 625, 50, 25)
        self.ticket_button.clicked.connect(self.ticket_button_ekle)

        self.dil_tr_button = QPushButton(self)
        self.dil_tr_button.setText("TR")
        self.dil_tr_button.setGeometry(5, 675, 50, 50)
        self.dil_tr_button.clicked.connect(self.tr_dil_ayar)

        self.dil_en_button = QPushButton(self)
        self.dil_en_button.setText("EN")
        self.dil_en_button.setGeometry(65, 675, 50, 50)
        self.dil_en_button.clicked.connect(self.en_dil_ayar)

        self.dil_ru_button = QPushButton(self)
        self.dil_ru_button.setText("RU")
        self.dil_ru_button.setGeometry(120, 675, 50, 50)
        self.dil_ru_button.clicked.connect(self.ru_dil_ayar)
        ...
        self.scan_button.setGeometry(1505, 520, 200, 75)
    ...
    def tr_dil_ayar(self):
        self.start_button.setText(self.dil_tr[0])
        self.pause_button.setText(self.dil_tr[1])
        self.delete_button.setText(self.dil_tr[2])
        self.save_button.setText(self.dil_tr[3])
        self.video_button.setText(self.dil_tr[4])
        self.openCV_label.setText(self.dil_tr[5])
        self.hsv_color_checkbox.setText(self.dil_tr[6])
        self.ticket_button.setText(self.dil_tr[7])
        self.etiket_label.setText(self.dil_tr[8])
        self.target_label.setText(self.dil_tr[9])
        self.scan_button.setText(self.dil_tr[10])
        self.radio_button1.setText(self.dil_tr[11])
        self.radio_button2.setText(self.dil_tr[12])
        self.radio_button3.setText(self.dil_tr[13])

    def en_dil_ayar(self):
        self.start_button.setText(self.dil_en[0])
        self.pause_button.setText(self.dil_en[1])
        self.delete_button.setText(self.dil_en[2])
        self.save_button.setText(self.dil_en[3])
        self.video_button.setText(self.dil_en[4])
        self.openCV_label.setText(self.dil_en[5])
        self.hsv_color_checkbox.setText(self.dil_en[6])
        self.ticket_button.setText(self.dil_en[7])
        self.etiket_label.setText(self.dil_en[8])
        self.target_label.setText(self.dil_en[9])
        self.scan_button.setText(self.dil_en[10])
        self.radio_button1.setText(self.dil_en[11])
        self.radio_button2.setText(self.dil_en[12])
        self.radio_button3.setText(self.dil_en[13])

    def ru_dil_ayar(self):
        self.start_button.setText(self.dil_ru[0])
        self.pause_button.setText(self.dil_ru[1])
        self.delete_button.setText(self.dil_ru[2])
        self.save_button.setText(self.dil_ru[3])
        self.video_button.setText(self.dil_ru[4])
        self.openCV_label.setText(self.dil_ru[5])
        self.hsv_color_checkbox.setText(self.dil_ru[6])
        self.ticket_button.setText(self.dil_ru[7])
        self.etiket_label.setText(self.dil_ru[8])
        self.target_label.setText(self.dil_ru[9])
        self.scan_button.setText(self.dil_ru[10])
        self.radio_button1.setText(self.dil_ru[11])
        self.radio_button2.setText(self.dil_ru[12])
        self.radio_button3.setText(self.dil_ru[13])

    def ticket_button_ekle(self):
        new_item = self.ticket_textbox.text().strip()
    ...
    def hsv_checkbox_state_changed(self, state):
            if state ==  Qt.Checked:
                ...
                self.hsv_color_checkbox.setEnabled(True)
    ...
    def start_video(self):
        ...
        if (self.textbox.text()=="" or self.ticket_combobox.currentText() ==""):
    ...
    def list_update(self):
        ...
        for i, dizi in enumerate(self.object_list):
            self.listbox.addItem(f"{i + 1}- {dizi['name']}")
    ...
    def frame_ticket(self,frame):
        if self.hsv_checkbox.isChecked():
            ...
            try:
                ...
                if self.hsv_color_checkbox.isChecked():
